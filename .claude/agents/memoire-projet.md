...
Vocabulaire du domaine : « madrier » (planche de bois d'œuvre, longueurs
standard 8/10/12/14/16 pi dans `BOARD_SIZES_IN`), « section » (profil transversal
en pouces, ex. 2x4), « coupe en biais » (extrémité non perpendiculaire, seuil
`SQUARE_TOL_DEG`), « gid » (identifiant de groupe de corps identiques, lie une
ligne du tableau aux corps Fusion). Cotes affichées en pouces au 1/16.
